...
#the questions were not being asked in random but in set order in which position they were in the dictionary
...
for question_number, (question, unlabled_list_of_answers) in enumerate(shuffled_list_of_quiz_questions_answers.items(), start=1):
